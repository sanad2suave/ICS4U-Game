...
def draw_new_game(saved_state=None):
    ...
    text_display = TextDisplay(['What are you looking at you bum? Spare me a dollar or get the \nhell out of my face!', 'H', 'You rat'])
    text_display.update()
    button_rect = None
    recep_display = TextDisplay(['Hello Todd. I am so sorry to hear about your brother. His body \n is somewhere in the floors upstairs. Be safe Todd.', 'H'])
